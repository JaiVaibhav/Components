...
function useThrottledInfiniteScroll(callback:()=>void, delay=500){
...
export default function InfiniteScroll(){
        ...
        const functionToBeCalled = useCallback(()=>{
        ...
        const handleScroll = useThrottledInfiniteScroll(functionToBeCalled);
